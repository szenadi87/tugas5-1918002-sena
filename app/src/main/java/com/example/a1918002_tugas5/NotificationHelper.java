package com.example.a1918002_tugas5;
...
public class NotificationHelper extends ContextWrapper {
    ...
    private void createChannel() { NotificationChannel channel = new NotificationChannel(
                channelID,
                channelName,
    ...
    public NotificationCompat.Builder getChannelNotification() {
        return new
                ...
                .setContentText("Wahai, manusia bangunlahh !!!!")
